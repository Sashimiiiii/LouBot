...
module.exports.run = async (bot, message, args, client) => {
 ...
 var user = message.author.tag
         ...
         console.log("[MICROWAVE] " + user + " used MICROWAVE sur " + member + " | " + time + " on " + date)
         ...
         if (message.guild.id == 730433603808264192) {
             ...
             channel.send("[MICROWAVE] " + user + " used MICROWAVE sur " + member + " | " + time + " on " + date)
         }
         
         bot.guilds.cache.get("554674515028738050").channels.cache.get("803747020522782720").send("[MICROWAVE] " + user + " used MICROWAVE sur " + member + " | " + time + " on " + date)
